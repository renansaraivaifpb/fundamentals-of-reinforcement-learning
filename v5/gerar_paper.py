...
p("Deep reinforcement learning (DRL) is widely reported to outperform "
  ...
  "(0.72 °C vs 0.77–0.89 °C) and lower cost (R$ 9.24 vs 9.59–10.44/day). "
...
p("O aprendizado por reforço profundo (DRL) é amplamente reportado como "
  ...
  "e menor custo (R$ 9,24 contra 9,59–10,44/dia). A decomposição dos +32 pp "
...
_ordem_t3 = ["PI sintonizado", "DQN Agressivo (550k)", "DQN Equilibrado (550k)",
             "DQN Passivo (550k)", "Termostato zona morta = 1 \u00b0C",
             "Termostato zona morta = 0"]
...
legenda("Figura 5. Origem da pressão de demanda. Apenas os cenários que partem "
...
p("A razão é uma contradição estrutural (Figura 5): os únicos cenários que "
